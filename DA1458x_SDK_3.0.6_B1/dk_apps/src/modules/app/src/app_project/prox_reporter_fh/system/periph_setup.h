...
/*
    ...
    #define GPIO_BAT_LED_PIN        GPIO_PIN_2
#else
    #define GPIO_ALERT_LED_PORT     GPIO_PORT_2
    #define GPIO_ALERT_LED_PIN      GPIO_PIN_4
...
#define UART2_PORT												GPIO_PORT_0
#define UART2_TX_PIN											GPIO_PIN_1
#define UART2_RX_PIN										GPIO_PIN_2

#define LASER_STATE_PORT					GPIO_PORT_0
#define LASER_STATE_PIN							GPIO_PIN_7
/*
